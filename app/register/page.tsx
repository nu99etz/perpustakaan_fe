                    ...
                    <div className="card-enter w-full max-w-md">
                        ...
                        <form noValidate className="space-y-4">
                            ...
                            <button type="submit" id="submit-btn"
                                className={`btn-shine w-full bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-bold py-3 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 mt-2 shadow-md shadow-indigo-200 dark:shadow-indigo-900`}>
