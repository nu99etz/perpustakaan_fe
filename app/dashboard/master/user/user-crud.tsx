...
export default function UserCrud({ initialUsers }: UserCrudProps) {
    ...
    return (
        <div className="grid gap-6 lg:grid-cols-[1fr_1.75fr]">
            <section className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 shadow-sm p-6">
                <h4 className="text-base font-bold text-slate-900 dark:text-white mb-4">{editing ? "Edit User" : "Tambah User Baru"}</h4>
