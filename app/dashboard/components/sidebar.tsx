    ...
    return (
        <aside className="hidden lg:flex flex-col w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 fixed inset-y-0 left-0 z-20 transition-colors duration-300">
            ...
            <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                <a href="#" className="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors">
                ...
                <a href="#" onClick={() => router.push('/dashboard/master/user')} className="nav-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-300 transition-colors">
